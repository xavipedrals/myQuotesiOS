...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) UIApplication * _Nullable kf_shared;)
+ (UIApplication * _Nullable)kf_shared;
@end
...
@interface UIImage (SWIFT_EXTENSION(Kingfisher))
+ (UIImage * _Nullable)kf_animatedWith:(NSData * _Nonnull)data scale:(CGFloat)scale duration:(NSTimeInterval)duration preloadAll:(BOOL)preloadAll;
+ (UIImage * _Nullable)kf_imageWithData:(NSData * _Nonnull)data scale:(CGFloat)scale preloadAllGIFData:(BOOL)preloadAllGIFData;
@end


@interface UIImage (SWIFT_EXTENSION(Kingfisher))
- (UIImage * _Nonnull)drawWithCgImage:(CGImageRef _Nullable)cgImage to:(CGSize)size draw:(void (^ _Nonnull)(void))draw;
@end


@interface UIImage (SWIFT_EXTENSION(Kingfisher))
- (UIImage * _Nullable)kf_decoded;
- (UIImage * _Nonnull)kf_decodedWithScale:(CGFloat)scale;
@end
...
+ (UIImage * _Nullable)kf_animatedWith:(NSArray<UIImage *> * _Nonnull)images forDuration:(NSTimeInterval)duration;
@end
...
- (UIImage * _Nonnull)kf_resizeTo:(CGSize)size for:(UIViewContentMode)contentMode;
/**
  Resize \code
  self
...
@property (nonatomic, readonly, copy) NSData * _Nullable kf_animatedImageData;
